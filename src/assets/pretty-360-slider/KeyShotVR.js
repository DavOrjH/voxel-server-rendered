...
window.keyshotVR=function(U,v,V,W,pa,D,qa,ra,sa,ta,ua,J,K,X,Y,va,Z,wa,$,xa,aa,ya,za,Aa,Ba,p){
					...
					function Ca(){
						var a= document.getElementById(U),d=a.requestFullScreen||a.webkitRequestFullScreen||a.mozRequestFullScreen||a.msRequestFullScreen;
					...
					function Fa(f){
						a.ma=r;a.F[f.pointerId]=[f.pageX,f.pageY];ea(f)
					}
					function fa(){
						a.l?(setTimeout(function(){a.u(z)},20),setTimeout(function(){a.u(r)},120)):(setTimeout(function(){a.u(r)},20),setTimeout(function(){a.u(z)},
						120))
					}
					function G(){
						var a={x:0,y:0},d=s;
					...
					function F(f){
						f||(f=window.event);
						var d=0;f.keyCode?d=f.keyCode:
					f.which&&(d=f.which);1==d?j.d|=1:1<d&&(j.d|=2);a.va(f);
					...
					function ea(f){
						...
						if(1==d.length&&d[0])
							if(j.start.x=d[0].pageX,j.start.y= d[0].pageY,j.a.x=d[0].pageX,j.a.y=d[0].pageY,a.pa=d[0].target,a.pa==a.r)j.d=1,ha(d[0].pageX,d[0].pageY);
							...
							if(2==d.length&&d[0]&&d[1]){
								...
								var e=d[0].pageX-d[1].pageX,g=d[0].pageY-d[1].pageY,i=(d[0].pageX-b.x+k.left+(d[1].pageX-b.x+k.left))/2,d=(d[0].pageY-b.y+k.top+(d[1].pageY-b.y+k.top))/2;
								c.oa=z;
					...
					function da(f){
						...
						if(2==b.length&&b[0]&&b[1]){
							...
							b=(a.cursor.y+b[1].pageY-e.y+k.top)/2-(j.ba.y+j.ca.y)/2;c.oa==z&&(c.m.x=h,c.m.y=b,c.oa=r);
							c.j+=(h-c.m.x)/c.g;c.k+=(b-c.m.y)/c.g;c.m.x=h;c.m.y=b}f.preventDefault()
					}
					function ka(){
						if(!ba())
						...
						var f=[];
						for(id in a.F){
							var b=a.F[id],e={};e.pageX=b[0];
							e.pageY=b[1];
							e.target=a.r;
							e.preventDefault=function(){};f.push(e)
						}return f
					}
					function ca(f){
						f.preventDefault();
						a.pa=t;
						j.d=0;
						var b=(new Date).getTime(),e=b-(Q||b+1);
						clearTimeout(R);
						500>e&&0<e||(Q=b,R=setTimeout(function(){clearTimeout(R)},500,[f]));
						Q=b
					}
					function Ga(a){
						a.preventDefault();
						...
						if(-1==a.ga){
							for(var b=1,b=0;b<a.G.length;b++){
								...
								if(0==a.w[c]&&a.G[b].complete){
									...
									a.w[c]=-1;
									if(a.W==a.Z){
										var h=a.G.length+a.za;h>e.q&&(h=e.q);
										if(h-=f)
											for(var g=0;g<h;g++)a.fa()
									}
								e.J=r;
								0==b&&a.Ba()}-1!=a.D[c]&&f++}b=parseFloat(f/e.q);a.Ra(b);
								f==e.q&&(a.ga=0,a.Qa())
						}
					}
					function la(a){
					...
					var A= "/",I=window.location.href,ma=I.lastIndexOf("/");	
								...
								if(e.J){
									...
									if(-1!=a.D[b]&&(na.setAttribute("src",a.C[b]),void 0!==p))
										if(b=a.ha[b],!b&&void 0==p[b]){
											...
											document.getElementById("vr_hotspot")&&(d=document.getElementById("vr_hotspot"),document.body.removeChild(d)), d=document.createElement("div"),d.innerHTML=p[b].text,d.id="vr_hotspot",d.style.position="absolute",d.style.left=p[b].position.x+"px",d.style.top=p[b].position.y+"px",d.style.color="#000000",void 0!==p[b].fb&&(p[b].options.fontSize&&(d.style.fontSize=p[b].options.fontSize),p[b].options.Ha&&(d.style.color=p[b].options.Ha),p[b].options.bgColor&&(d.style.backgroundColor=p[b].options.bgColor),p[b].options.link&&(d.href=p[b].options.link),p[b].options.height&&(d.style.height=p[b].options.height),p[b].options.width&&(d.style.width=p[b].options.width),p[b].options.textAlign&&(d.style.textAlign=p[b].options.textAlign)),document.body.appendChild(d)
									}
					...
					this.bb=function(b){
								for(var d=-1E3,c=b,h=parseFloat(parseInt(b%e.c)),g=parseFloat(parseInt(b/e.c)),h=h/e.c,h=h*2*Math.PI,g=g/e.i,g=g*Math.PI,b=Math.sin(h),h=Math.cos(h),g=Math.cos(g),i=Math.sqrt(b*b+h*h+g*g),b=b/i,h=h/i,g=g/i,i=0;i<a.G.length;i++){
									var j=a.B[i];
									if(-1!=a.D[j]){
										var k=a.Da[j].Xa,k=b*k.x+h*k.y+g*k.Ya;
										d<k&&(d=k,c=j)
									}
								}
					...
					this.fa=function(){
								if(a.na<e.q){
									var b=new Image,d=a.B[a.na];
									a.w[d]=0;
									//src de imágenes
									b.src=a.C[d];
									a.G.push(b);
									var c=parseInt(d%e.c),h=parseInt(d/e.c),c=c/e.c,c=c*2*Math.PI,h=h/e.i,h=h*Math.PI,b=Math.sin(c),c=Math.cos(c),h=Math.cos(h),g=Math.sqrt(b*b+c*c+h*h);
					...
					this.Fa=function(){
								for(var b=e.qa,d=e.ra,c=2,h=parseFloat(e.c/c),g=parseFloat(e.i/c),i=e.q,j=0,k=0,m=0,n=0,l=0;a.P<i;){
									var q=parseInt(b%e.c),s=parseInt(d%e.i),l=parseInt(s*e.c+q);
									...
									if(n>=c)
										if(n=0,0==j)
											...
											if(1>h&&1>g){
												for(b=0;b<i;b++)
													d=parseInt(b%e.c),c=parseInt(b/e.c),l=parseInt(c*e.c+d),a.C[l]||(a.B[a.P]=l,a.P++,a.C[l]=a.ua(d,c),void 0!==p&&p[c+"_"+d]&&(a.ha[l]=c+"_"+d));
													break
												}
											j=m=k=0
										}
					...
					this.ua=function(b,d){
								var url = "http://assets.voxel3d.net/gallery-3d/"
								return url+a.s+"/"+parseInt(d)+"_"+parseInt(b)+"."+ xa
							};
					this.la=function(b,d){
								var b=b*(1<e.c?a.Va:0),d=d*(1<e.i?a.Wa:0),c=Math.sqrt(b*b+d*d);
					...
					this.Ua=function(){
								a.u(!a.l);
								// src de iconos full screen y go fixed size
								var url = "http://assets.voxel3d.net/gallery-3d/"
								a.l?a.H.setAttribute("src",url+"/files/GoFullScreenIcon.png"):a.H.setAttribute("src",url+"/files/GoFixedSizeIcon.png")
							};
					this.u=function(b){
						a.l=b;
					...
					this.va=function(b){
								var d=G();
								a.cursor.x=b.pageX-d.x+k.left;a.cursor.y=b.pageY-d.y+k.top;
					...
					this.Sa=function(b,d){
								...
								var c=b-k.left-k.right,e=d-k.top-k.bottom;C.width=c;
								C.height=e;
								s.style.width=c+"px";
								a.l&&window.innerHeight<B.height&&(e=window.innerHeight);
								s.style.height=e+"px";
								s.style.left=k.left+"px";s.style.top=k.top+"px";
								ga();
								n.style.width=b+"px";
					...
					var Ha=window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,10)};
					this.ta=function(){
								...
								//src de inner html
								a.o.innerHTML='<img src="'+"http://assets.voxel3d.net/gallery-3d/"+a.s+"/"+"/files/"+c+'"></img>';
								a.p.appendChild(a.o);
								a.p.appendChild(a.Q);
								n.appendChild(a.p);a.u(a.l);
								setTimeout(function(){a.u(a.l)},10)
							};
					this.Ra=function(b){
								if(a.p){
									a.Q.innerHTML="<center>"+parseInt(100*b)+"</center>";a.o.$.ia+=2.1;b="";
									if(a.o.$)
										var d=a.o.$,b=b+("translate("+d.Ma+"px,"+d.Na+"px) rotate("+d.ia+"deg) scale("+d.Oa+","+d.Pa+") ");
					...
					this.ya=function(){
								...
								za&&m(n,"dblclick",Ca);
								if(ba())
									if(m(window,"mousewheel",P),m(window,"keydown",la),/Tablet PC/i.test(navigator.userAgent)&&window.$a){
										var b=new MSGesture;
										b.target=a.h;a.h.Ia=b;
										...
										m(n,"mousedown",F),m(q,"mousedown",F),m(n,"mousemove",H),m(q,"mousemove",H),m(document,"mouseup",N);
								else 
									n.addEventListener&&(m(document,"mouseup",N),m(n,"mousewheel",P),m(document,"keydown",la),m(n,"mousedown",F),m(q,"mousedown",F),m(n,"mousemove",H),m(n,"touchstart",ea),m(n,"touchmove",da),m(n,"touchcancel",Ga),m(n,"touchend",ca),m(n,"DOMMouseScroll",P),m(window,"orientationchange",fa))
							};
					if(document.createElement("canvas").getContext){
						var a=this,u=a.h=t,s=t,na=t,n=t,q=t;
						a.l=Z;
						a.s=v;
						a.cb=z;
						a.Z=z;
						...
						a.Y=0;
						a.ga=-1;
						var k={left:0,top:0,right:0,bottom:0},e={I:0,K:0,c:1,i:1,qa:0,ra:0,z:0,da:0,ea:0,J:z,q:0,Ca:r,Ea:z};
						J||(J=0);
						K||(K=0);
						e.qa=J;
						e.ra=K;
						...
						B.width=V;
						B.height=W;
						var y="",L="transform",C={x:640,y:480},c={n:1,t:1,a:-1,j:0,k:0,wa:-1,xa:-1,g:1,ka:1,ja:1,m:{x:0,y:0},oa:z};
						c.ka=parseFloat(X);
						c.ja=parseFloat(Y);
						var l={start:{x:0,y:0},a:{x:0,y:0},La:{x:0,y:0},n:{x:0,y:0},b:{x:0,y:0}},E={start:{x:0,y:0}},j={d:0,start:{x:0,y:0},a:{x:0,y:0},La:{x:0,y:0},n:{x:0,y:0},b:{x:0,y:0},ba:{x:0,y:0},ca:{x:0,y:0}},i={a:{x:0,y:0},b:{x:0,y:0},L:0.96};
						i.L=va;
						a.cursor={x:0,y:0};
						var w=[],x=[];
						w[0]=0;
						...
						for(D=0;D<v.length;D++)
							"undefined"!=typeof document.documentElement.style[v[D]+"Transform"]&&(y="-"+v[D].toLowerCase()+"-",L=v[D]+"Transform");
						var b="";
						...
						this.O.onload=function(){a.Ja()};
						a.U(this.A);
						this.A.appendChild(this.O);
						n.appendChild(this.A);
						//src de full screen and fixed
						let url = "http://assets.voxel3d.net/gallery-3d/";
						this.backgroundColor=s.style.backgroundColor=pa;wa&&(a.S=document.createElement("div"),b="position:absolute;",b+="width: 38px;",b+="height: 32px;",b+=y+"transform-origin: 50% 50%;",b+="visibility: inherit;",b+="cursor: pointer;",a.S.setAttribute("style",b),a.H=document.createElement("img"),a.l?a.H.setAttribute("src",url+a.s+"/files/GoFullScreenIcon.png"):a.H.setAttribute("src",url+a.s+"/files/GoFixedSizeIcon.png"),a.H.setAttribute("style","position: absolute;top: 0px;left: 0px;width: 38px;height: 32px;"),a.S.appendChild(a.H),a.S.V=function(a,b){this.style.left=a-38+"px";this.style.top=b-32+"px"},a.S.onclick= function(){a.Ua()},a.r.appendChild(a.S));
						if(a.W){
							...
							//src de hand gif y cursor
							I?a.X.setAttribute("src",url+a.s+"/files/vr_hand.gif"):a.X.setAttribute("src",url+a.s+"/files/vr_cursor.gif");
							...
							a.r.ontouchstart=function(a){
												T||oa();a.preventDefault()
											};
							a.r.appendChild(a.M);
							a.ya()
						}else 
							a.W=r,a.Z=r,aa&&a.ta(),a.ya(),a.sa();
						a.u(Z);
						a.R=1/c.g;a.T(a.R);
						this.Fa();
						a.fa();
						setTimeout(function(){S()},10);
						setTimeout(function(){M()},15)
