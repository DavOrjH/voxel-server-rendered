...
@Component({
  selector: 'app-enginnering-and-fab',
  templateUrl: './engineering-and-fab.component.html',
  styleUrls: ['./engineering-and-fab.component.css'],
  animations: [
...
export class EngineeringAndFabComponent implements OnInit,AfterViewInit {
