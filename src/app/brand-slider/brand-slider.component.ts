...
options:any={};
  ...
  setSlider():void{
   ...
   let object:any = {
    ...
    this.sliderFunc(object, this.id);
    this.options=object;
  }

  sliderFunc(options:any, id:string):void{
      ...
      resize: function(object){
            ...
            *******************************/        
            ...
            if (methods[options]) {     // $("#element").pluginName('methodName', 'arg1', 'arg2');
                ...
                $.error( 'Method "' +  methods + '" does not exist in flexisel plugin!');
            }        
    };

    this.func = $(window).load(function() {
