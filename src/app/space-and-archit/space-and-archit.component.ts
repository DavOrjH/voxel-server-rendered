...
@Component({
  selector: 'app-space-and-archit',
  templateUrl: './space-and-archit.component.html',
  styleUrls: ['./space-and-archit.component.css'],
  animations: [
...
export class SpaceAndArchitComponent implements OnInit,AfterViewInit {
