...
@Component({
  selector: 'app-protesis-ortesis',
  templateUrl: './protesis-ortesis.component.html',
  styleUrls: ['./protesis-ortesis.component.css']
})
export class ProtesisOrtesisComponent implements OnInit {
    ...
    let sliderData = [];
      products.forEach(product => {        
        for(let i = 0; i< product.sectors.length;i++) {          
          if(product.sectors[i].name == "protesis-ortesis"){
