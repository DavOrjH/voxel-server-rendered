...
export class DiseñoComponent implements OnInit {
  ...
  imagesArray:Images[] = [
    new Images("http://assets.voxel3d.net/sectores/arquitectura/diseno/Alcoba_SebastianParra.jpg","Alcoba","Sebastián Parra"),
    new Images("http://assets.voxel3d.net/sectores/arquitectura/diseno/AtardeceInterior_ChristianGamez.jpg","Atardecer interior","Christian Gamez"),
    new Images("http://assets.voxel3d.net/sectores/arquitectura/diseno/Comedor_LeonardoGuio.jpg","Comedor","Leonardo Guio"),
    new Images("http://assets.voxel3d.net/sectores/arquitectura/diseno/Oficina_JesusAmaya.png","Oficina","Jesus Amaya"),
    ...
    let sliderData = [];
      products.forEach(product => {        
        for(let i = 0; i< product.sectors.length;i++) {          
          if(product.sectors[i].name == "diseño"){
